                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">@lang('Sign up')</p>
                                    <form class="mx-1 mx-md-4" action="{{ route('frontend.auth.register') }}"
                                          method="POST">
                                        @csrf
                                        @method('POST')
                                        <small id="error_name"
                                               class="error text-danger">{{ $errors->first('name') }}</small>
                                        ...
                                        <small id="error_name"
                                               class="error text-danger">{{ $errors->first('email') }}</small>
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div class="form-outline flex-fill mb-0">
                                        ...
                                        <small id="error_name"
                                               class="error text-danger">{{ $errors->first('password_confirmation') }}</small>
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div class="form-outline flex-fill mb-0">
